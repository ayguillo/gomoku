...
func CounterVertical(ctx *s.SContext, case_x int, case_y int, capturePlayer int) bool {
	...
	if case_capture == true && count_stone == 2 && current_case >= 3 {
...
func CounterHorizontal(ctx *s.SContext, case_x int, case_y int, capturePlayer int) bool {
	...
	if case_capture == false && count_stone == 2 {
		if case_x > 0 && case_x < int(ctx.NSize-2) {
...
func CounterDiagRight(ctx *s.SContext, case_x int, case_y int, capturePlayer int) bool {
	...
	if case_capture == true && count_stone == 2 && current_case_x > 3 && current_case_y > 3 {
	...
	if case_capture == false && count_stone == 2 {
		if case_x > 0 && case_y > 0 && case_x < int(ctx.NSize-2) && case_y < int(ctx.NSize-2) {
			if ctx.Goban[case_y-1][case_x-1] == s.Tnumber(capturePlayer) {
				ctx.Capture = append(ctx.Capture, s.SVertex{X: case_x + 2, Y: case_y + 2})
				return true
			}
		}
		if (current_case_x >= 0 && current_case_x < int(ctx.NSize-3)) && (current_case_y >= 0 && current_case_y < int(ctx.NSize-3)) {
			if ctx.Goban[current_case_y][current_case_x] == s.Tnumber(capturePlayer) {
				ctx.Capture = append(ctx.Capture, s.SVertex{X: current_case_x + 3, Y: current_case_y + 3})
				return true
			}
...
func CounterDiagLeft(ctx *s.SContext, case_x int, case_y int, capturePlayer int) bool {
	...
	if case_capture == true && count_stone == 2 && current_case_x >= 3 && current_case_y < int(ctx.NSize-3) {
		ctx.Capture = append(ctx.Capture, s.SVertex{X: current_case_x - 3, Y: current_case_y + 3})
		return true
	}
	if count_stone < 2 {
	...
	if case_capture == false && count_stone == 2 {
		if case_x >= 2 && case_y < int(ctx.NSize)-1 && case_x < int(ctx.NSize-2) && case_y >= 2 {
			if ctx.Goban[case_y+1][case_x-1] == s.Tnumber(capturePlayer) {
				ctx.Capture = append(ctx.Capture, s.SVertex{X: case_x + 2, Y: case_y - 2})
				return true
			}
		}
		if (current_case_x >= 0 && current_case_x < int(ctx.NSize-3)) && (current_case_y >= 3 && current_case_y < int(ctx.NSize)) {
			if ctx.Goban[current_case_y][current_case_x] == s.Tnumber(capturePlayer) {
				ctx.Capture = append(ctx.Capture, s.SVertex{X: current_case_x + 3, Y: current_case_y - 3})
				return true
			}
